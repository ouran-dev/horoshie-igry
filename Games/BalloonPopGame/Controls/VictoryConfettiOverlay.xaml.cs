...
/// <summary>Большое конфетти на весь экран при победе на уровне.</summary>
public partial class VictoryConfettiOverlay : UserControl
{
    private static readonly string[] ParticleEmojis = ["🎉", "🎊", "⭐", "✨", "💫", "🎈"];

    private readonly Random _random = new();

    public VictoryConfettiOverlay()
    {
        InitializeComponent();
    }
